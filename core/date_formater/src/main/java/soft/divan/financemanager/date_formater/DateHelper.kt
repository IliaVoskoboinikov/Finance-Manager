package soft.divan.financemanager.date_formater
...
object DateHelper {
    ...
    /**
     * Преобразует [java.time.LocalDate] в строку формата API (`yyyy-MM-dd`).
     *
    ...
    /**
     * Парсит строку в формате API (`yyyy-MM-dd`) в [java.time.LocalDate].
     *
     * @param apiDateString строка, полученная из API
     * @return соответствующий [java.time.LocalDate], либо текущая дата при ошибке
     */
    ...
    /**
     * Парсит строку из отображаемого формата (`dd.MM.yyyy`) в [java.time.LocalDate].
     *
     * @param displayDateString дата в виде строки
     * @return [java.time.LocalDate], либо текущая дата при ошибке парсинга
     */
    ...
    /**
     * Форматирует [java.time.LocalDate] в строку для отображения (`dd.MM.yyyy`).
     */
    ...
    /**
     * Расширение для преобразования [java.util.Date] в [java.time.LocalDate].
     *
    ...
    /**
     * Расширение для преобразования [java.time.LocalDate] в [java.util.Date].
     *
