package soft.divan.financemanager.feature.haptics.haptics_impl.precenter.screen
...
import soft.divan.financemanager.feature.haptics.haptics_impl.R
import soft.divan.financemanager.feature.haptics.haptics_impl.precenter.model.HapticsUiState
import soft.divan.financemanager.feature.haptics.haptics_impl.precenter.viewModel.HapticsViewModel
...
private fun HapticsSuccessContent(
    ...
    Row(
        ...
        Text(text = stringResource(id = R.string.haptics), style = MaterialTheme.typography.bodyLarge)
