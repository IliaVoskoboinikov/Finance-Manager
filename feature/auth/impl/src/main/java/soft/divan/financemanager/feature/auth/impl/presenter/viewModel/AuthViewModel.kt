...
import soft.divan.financemanager.feature.auth.impl.presenter.model.*
    ...
    fun onAction(action: AuthAction) {
        when (action) {
            ...
            AuthAction.ToggleMode -> {
                _uiState.updateContent { it.copy(authUi = it.authUi.copy(isLoginMode = !it.authUi.isLoginMode)) }
            }
