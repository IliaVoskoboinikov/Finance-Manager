...
Реализует `AuthFeatureApi` из `:feature:auth:api`: экраны профиля и повторного входа —
в графе вкладок, экран входа как точка входа в приложение — в корневом графе `app`.
