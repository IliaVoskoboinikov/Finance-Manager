...
include(":feature:my-accounts:my-accounts-api")
include(":feature:my-accounts:my-accounts-impl")
...
include(":core:logging-error:logging-error-impl")
include(":core:logging-error:logging-error-api")
include(":feature:haptics:haptics-api")
include(":feature:haptics:haptics_impl")
include(":feature:sounds:sounds-api")
include(":feature:sounds:sounds-impl")
include(":feature:languages:languages-api")
include(":feature:languages:languages-impl")
include(":feature:synchronization:synchronization-api")
include(":feature:synchronization:synchronization-impl")