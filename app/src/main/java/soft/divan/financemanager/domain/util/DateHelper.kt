...
object DateHelper {
    ...
    /**
     * Парсит строку из API-даты с временем в формате UTC в [Instant].
     *
     * @param apiDateTimeString строка формата `yyyy-MM-dd'T'HH:mm:ss.SSS'Z'`
     * @return [Instant], либо текущий момент времени при ошибке
     */
    ...
    /**
     * Форматирует [LocalTime] в строку (`HH:mm`).
     */
    ...
    /**
     * Расширение для преобразования [Date] в [LocalDate].
     *
